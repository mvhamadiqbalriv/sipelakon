...
<head>
    ...
    <meta name="keywords" content="Sumedang">
    <meta name="description" content="SIPELAKON">
...
<body>
        ...
        <div class="container">
            <div class="row tt-row no-gutters">
                <div class="col-auto">
                    ...
                    <!-- logo -->
                    <div class="tt-logo">
                        <a href="index.html"><img src="{{asset('assets/back/images/sumedang.png')}}" alt=""></a>
                    </div>
                    <!-- /logo -->
                    <!-- desctop menu -->
                    <div class="tt-desktop-menu">
                        <nav>
                            <ul>
                                @php
                                    $urlMentah = url()->current();
                                    $url = explode('/',$urlMentah);
                                @endphp
                                <li @if($url[3] == 'dashboard') class="active" @endif><a href="{{url('dashboard')}}"><span>Dashboard</span></a></li>
                                ...
                                <li><a href="#">
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        this.closest('form').submit();"href="{{route('logout')}}" style="color:red">Logout <i class="fa fa-out"></i></span>
                                    </form>
                                </span></a></li>
                            </ul>
                        </nav>
                ...
                @auth
                    <div class="col-auto ml-auto">
                        ...
                        <div class="tt-avatar-icon tt-size-md">
                                ...
                                @endphp
                            <i class="tt-icon"><svg><use xlink:href="#icon-ava-{{$firstCharacter}}"></use></svg></i>
                        </div>
    ...
    <a href="{{route('post.create')}}" class="tt-btn-create-topic">
        <span class="tt-icon">
            <svg>
    ...
    <script src="{{asset('assets/back/js/bundle.js')}}"></script>
    @yield('js')
